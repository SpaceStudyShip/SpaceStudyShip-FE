...
class AppTheme {
  ...
  static ThemeData get darkTheme => ThemeData(
        ...
        textTheme: TextTheme(
          ...
          titleLarge: AppTextStyles.label_16.copyWith(
            color: AppColors.textPrimary,
          ),
          ...
          bodySmall: AppTextStyles.tag_12.copyWith(
            color: AppColors.textTertiary,
          ),
          labelLarge: AppTextStyles.label_16.copyWith(
            color: AppColors.textPrimary,
          ),
          labelMedium: AppTextStyles.tag_12.copyWith(
            color: AppColors.textSecondary,
          ),
          labelSmall: AppTextStyles.tag_10.copyWith(
            color: AppColors.textTertiary,
          ),
        ),
